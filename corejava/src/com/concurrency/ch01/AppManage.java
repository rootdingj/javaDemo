...
public class AppManage {
	...
	private static String READ_FILE_PATH = "D:\\user_score.csv";
	private static String WRITER_FILE_PATH = "D:\\\\user_score_out.csv";
	...
	public void init() throws IOException {
		...
		spliFile(READ_FILE_PATH, paths);
		mergeFile(WRITER_FILE_PATH, paths);
	}
